 ...
 */
public class BigDecimal2LongStrategy implements ConvertStrategy {
    ...
    public void convertAB(MethodSpec.Builder buildConvertAB, String from, String to, ModifyStrategy modifyStrategy, String fieldUpperCase) {
        buildConvertAB.addStatement("to.set" + fieldUpperCase + "(" + modifyStrategy.getModifyName("from") + ".longValue())");
    }
